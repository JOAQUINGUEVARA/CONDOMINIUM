...
urlpatterns = [
   ...
   path('lista_legislacion/',views.ListaLegislacionView,name='lista_legislacion'),
   ...
   path('lista_comunicados/',views.ListaComunicadoView,name='lista_comunicados'),
   ...
   path('lista_normatividad/',views.ListaNormatividadView,name='lista_normatividad'),
